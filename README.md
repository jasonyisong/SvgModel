...
- The attributes for the basic Shapes (elements) typically used in vector graphics applications, and Shapes also have line styles, line thicknesses, line colours, fill colours, etc.
